...
public class Enemy : MonoBehaviour
{
   ...
   private EnemyMovement enemyMovementAI;
    ...
    public void EnemyInitialization(EnemyDetails enemyDetails, int enemySpawnNumber, DungeonLevelScriptableObject dungeonLevel)
    {
    ...
    /// </summary>
    private void SetEnemyStartingHealth(DungeonLevelScriptableObject dungeonLevel)
    {
        ...
        foreach (EnemyHealthDetails enemyHealthDetails in enemyDetails.enemyHealthDetailsArray)
        {
            ...
            {
                health.setStartingHP(enemyHealthDetails.enemyHealthAmount);
                return;
            }
        }
