...
public class Chest : MonoBehaviour, IUseable
{
    ...
    /// </summary>
    public void Initialize(bool shouldMaterialize, int healthPercent, WeaponDetails weaponDetails, int ammoPercent)
    {
    ...
    private void CollectHealthItem()
    {
        ...
        GameManager.Instance.GetPlayer().hp.AddHealth(healthPercent);
    ...
    private void CollectAmmoItem()
    {
        ...
        player.reloadWeaponEvent.CallReloadWeaponEvent(player.activeWep.GetCurrentWeapon(), ammoPercent);
    ...
    private void InstantiateWeaponItem()
    {
        ...
        chestItemGameObject.GetComponent<ChestItem>().Initialize(weaponDetails.weaponIcon, weaponDetails.weaponTitle, itemSpawnPoint.position, materializeColor);
    }
    ...
    private void CollectWeaponItem()
    {
        ...
        if (!GameManager.Instance.GetPlayer().IsWeaponHeldByPlayer(weaponDetails))
        {
            ...
            GameManager.Instance.GetPlayer().AddWepToPlayer(weaponDetails);
