...
public class ChestSpawner : MonoBehaviour
{
    ...
    #endregion Tooltip
    [SerializeField] private List<SpawnableObjectsByLevel<WeaponDetails>> weaponSpawnByLevelList;
    #region Tooltip
    ...
    private void SpawnChest()
    {
        ...
        else if (chestSpawnPosition == ChestSpawnPosition.atPlayerPosition)
        {
            ...
            Vector3 spawnPosition = HelperUtilities.GetNearestSpawnPoint(GameManager.Instance.GetPlayer().transform.position);
    ...
    /// </summary>
    private WeaponDetails GetWeaponDetailsToSpawn(int weaponNumber)
    {
        ...
        RandomSpawnableObject<WeaponDetails> weaponRandom = new RandomSpawnableObject<WeaponDetails>(weaponSpawnByLevelList);

        WeaponDetails weaponDetails = weaponRandom.GetItem();
    ...
    private void OnValidate()
    {
        ...
        {
            foreach (SpawnableObjectsByLevel<WeaponDetails> weaponDetailsByLevel in weaponSpawnByLevelList)
            {
                HelperUtilities.ValidateCheckNullValue(this, nameof(weaponDetailsByLevel.dungeonLevel), weaponDetailsByLevel.dungeonLevel);

                foreach (SpawnableObjectRatio<WeaponDetails> weaponRatio in weaponDetailsByLevel.spawnableObjectRatioList)
                {
