...
public class ActiveWeapon : MonoBehaviour
{
    ...
    {
        SetWeapon(setActiveWeaponEventArgs.wep);
    }
    ...
    private void SetWeapon(Weapon weapon)
    {
        ...
        weaponSpriteRenderer.sprite = currentWeapon.wepDetails.weaponIcon;
        ...
        weaponShootPositionTransform.localPosition = currentWeapon.wepDetails.shootPositionOffset;
    }

    public AmmoDetails GetCurrentAmmo()
    {
        return currentWeapon.wepDetails.currentAmmo;
    }
